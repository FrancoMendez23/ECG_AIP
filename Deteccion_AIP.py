...
def main(file, varname, lead, fs):
    ...
    peaks, detector,thr_min,thr_max = Detect_Patron(ecg_golay,pattern,fs,percentile_min=80,trgt_width= 0.01,trgt_min_pattern_separation=0.5,percentile_max=None)
